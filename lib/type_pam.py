...
from config import PAM_FILE_SYSTEM, PAM_FILE_TOTP, PAM_FILE_CUSTOM
...
def auth_custom(user: str, secret: str) -> bool:
    return _auth_pam(user=user, secret=secret, pam_module=PAM_FILE_CUSTOM)
